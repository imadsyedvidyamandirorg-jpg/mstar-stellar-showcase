        ...
        <div className="flex items-center justify-between h-14 md:h-16">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            {user ? (
              ...
              <Link
                to="/auth"
                className="hidden md:flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium bg-accent text-accent-foreground hover:bg-accent/90 transition-all"
              >
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              {user ? (
                ...
                <Link
                  to="/auth"
                  onClick={() => setMobileOpen(false)}
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl text-xs font-medium bg-accent text-accent-foreground"
                >
