...
const DashboardNav = () => {
  ...
  const navItems = [
    ...
    { name: "Watch Reels", href: "/dashboard/reels", icon: Film },
    { name: "Posts", href: "/dashboard/posts", icon: Image },
    { name: "Notifications", href: "/dashboard/notifications", icon: Bell },
    { name: "New Offers", href: "/dashboard/offers", icon: Gift },
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img src={mstarLogo} alt="MStar" className="h-10" />
          </Link>
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/dashboard/cart"
              className="relative flex items-center gap-2 px-4 py-2 rounded-lg text-primary-foreground/70 hover:text-primary-foreground hover:bg-mstar-dark transition-all"
            >
        ...
        {/* Mobile Nav */}
        {mobileOpen && (
          <div className="lg:hidden py-4 border-t border-mstar-gray/20 animate-slide-up">
